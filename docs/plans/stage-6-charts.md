...
**Version:** v1 (RATIFIED 2026-07-12 — chart tasks blocked until the v2 bump fills the height table, per Task 0)
**Date:** 2026-07-12
...
|---|---|---|
| Evolución del Flujo Neto (line) | ⛔ PENDING-EXTRACTION | ⛔ PENDING-EXTRACTION |
| Gastos por Método de Pago (bar) | ⛔ PENDING-EXTRACTION | ⛔ PENDING-EXTRACTION |
| Gastos por Categoría (doughnut) | ⛔ PENDING-EXTRACTION | ⛔ PENDING-EXTRACTION |
